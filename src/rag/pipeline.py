# -*- coding: utf-8 -*-
"""
RAG pipeline implementation for the Radio Barcelona archive

This module provides the core retrieval and generation logic for the GUIRAD collection
"""
...
{{
  "retrieval_mode": "vector|hybrid|provenance_lookup",
  "filters": [
...
def safe_parse_json_response(text: str):  # Helper: NEW HECTOR
    text = text.strip()
    ...
    print("[planner_raw_debug]", repr(candidate))
...
class QueryClassifier:
    ...
    def classify(self, question: str, explicit_filters: Optional[MetadataFilters] = None) -> QueryPlan:
        return self._classify_rules(question, explicit_filters=explicit_filters)
